...
public class TestNet3Params extends AbstractBitcoinNetParams {
    ...
    public TestNet3Params() {
        ...
        dnsSeeds = new String[] {
                "testseed.jrn.me.uk", // Jonas Schnelli
...
//                        URI.create("http://testnet.httpseed.bitcoin.schildbach.de/peers")
        ...
        bip32HeaderP2WPKHpub = 0x00000000; // The 4 byte header that serializes in base58 to "vpub".
        bip32HeaderP2WPKHpriv = 0x00000000; // The 4 byte header that serializes in base58 to "vprv"
...
//    private static final Date testnetDiffDate = new Date(1329264000000L);
      private static final Date testnetDiffDate = new Date(0000000000000L);
