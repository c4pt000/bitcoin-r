...
public class MainNetParams extends AbstractBitcoinNetParams {
    ...
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 0;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 0;
    ...
    public MainNetParams() {
        ...
        bip32HeaderP2WPKHpub = 0x02facafd; // The 4 byte header that serializes in base58 to "xpub".
        bip32HeaderP2WPKHpriv = 0x02fac398; // The 4 byte header that serializes in base58 to "xprv"
...
//        checkState(genesisHash.equals(""),
  //          genesisHash);
        ...
        checkpoints.put(100, Sha256Hash.wrap("40599f2a024dc20841db7c06f71cf66a63ffc6aa664528e7281a5c9f0be4c665"));
...
*/
        dnsSeeds = new String[] {
                "seed-ns1.radioblockchain.info",         // Pieter Wuille
                "seed-ns2.radioblockchain.info",          // Matt Corallo
                "seed-ns3.radioblockchain.info",   // Luke Dashjr
